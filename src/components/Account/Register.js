            ...
            <div className="signin border-4 py-5 border-dashed border-gray-600 shadow-2xl m-auto rounded-3xl lg:w-3/5 md:w-4/5 w-full  relative bg-purple-600">
                ...
                <div className="sign h-2/3 py-3 rounded-3xl mb-12">
                    ...
                    <form className=' mt-1 w-2/3 px-5 m-auto' onSubmit={handleSubmit}>
                        ...
                        {
                            sumerror && <div>
                                <input type="submit" value={"Register"} className='mt-2 focus:outline-none shadow-md w-full text-white py-3 px-5 bg-gradient-to-r from-red-700 to-red-500 hover:to-red-800 ease-in-out rounded-2xl '/> <br />
                            </div>
                        }
                                                {
                            !sumerror && <div>
                                <input type="submit" value={"Register"} className=' p-2 focus:outline-none shadow-md w-full text-white py-3 px-5 bg-gradient-to-r from-pink-600 to-yellow-400 hover:to-yellow-600 ease-in-out rounded-2xl '/> <br />
                            </div>
                        }
                    </form>
