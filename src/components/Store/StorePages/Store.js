...
const Store = () => {
    ...
    return (
        <div className="px-10 py-5 bg-gradient-to-r from-pink-700 to-yellow-400 h-auto ">
            ...
            <div className="bg-gray-50 py-5 md:gap-6 gap-3 text-center h-auto flex justify-center rounded-2xl bg-opacity-25">
            ...
            <div className='h-auto p-3 bg-white bg-opacity-40 w-full my-5 pb-8 rounded-2xl'>
                ...
                <div className=' h-full w-full flex gap-5 py-3 px-10 justify-center'>
            ...
            <div className='flex w-full h-screen gap-5 p-3'>
