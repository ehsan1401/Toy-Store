        ...
        <div>
            {
                ...
                !light &&
                    <div className="h-auto bg-gradient-to-r from-sky-800 to-slate-700 px-10 py-5">
                        <h1 className="font-bold text-4xl text-gray-200 py-5">Suitable products for age category {rate}</h1>
                        <div className='md:flex flex-wrap grid py-3 px-10 justify-center gap-3'>
                            {
                                Toys.sort((a, b) => (Number(a.Price) < Number(b.Price)) ? 1 : -1).map((toy)=>{
                                    if(toy.Ages === rate){
