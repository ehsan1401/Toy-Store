          ...
          <Card sx={{ maxWidth: 300 , Height: 700 ,boxSizing: 'border-box' , background:grey[300]  }} >
            ...
            <CardActions>
              ...
              
              {
                ...
                !suplly && <h1 className='font-thin text-xl ml-8 mr-8 text-red-500'>Nonexistence</h1>
              }
            ...
            <Card sx={{ maxWidth: 300 , Height: 700 ,boxSizing: 'border-box' , background:grey[800]  }} >
              ...
              <CardActions>
                ...
                
                {
                  ...
                  !suplly && <h1 className='font-thin text-xl ml-4 mr-4 text-red-300'>Nonexistence</h1>
                }
