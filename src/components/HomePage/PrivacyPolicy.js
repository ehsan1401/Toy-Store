        ...
        <div>
            {
                ...
                !light &&
                <div className="Contactus py-10 px-32 bg-gradient-to-r from-stone-500 to-stone-700 ">
                    <div className="bg-gray-700 p-10 rounded-xl text-gray-100">
                        <h1 className="font-bold text-4xl text-gray-300">Privacy Policy</h1>
                        <div className="p-5 font-thin">
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tempora reprehenderit, quam est distinctio ipsam, ex assumenda magnam in ipsum quod fuga officiis deserunt impedit eligendi, harum consectetur consequatur. Tempora, incidunt!</p>
                            <h5 className="font-bold text-gray-300 text-2xl py-3">Title1</h5>
                            <div className="pl-5">
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tempora reprehenderit, quam est distinctio ipsam, ex assumenda magnam in ipsum quod fuga officiis deserunt impedit eligendi, harum consectetur consequatur. Tempora, incidunt!</p>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tempora reprehenderit, quam est distinctio ipsam, ex assumenda magnam in ipsum quod fuga officiis deserunt impedit eligendi, harum consectetur consequatur. Tempora, incidunt!</p>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tempora reprehenderit, quam est distinctio ipsam, ex assumenda magnam in ipsum quod fuga officiis deserunt impedit eligendi, harum consectetur consequatur. Tempora, incidunt!</p>
                            ...
                            <h5 className="font-bold text-gray-300 text-2xl py-3">Title2</h5>
                            <div className="pl-5">
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tempora reprehenderit, quam est distinctio ipsam, ex assumenda magnam in ipsum quod fuga officiis deserunt impedit eligendi, harum consectetur consequatur. Tempora, incidunt!</p>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tempora reprehenderit, quam est distinctio ipsam, ex assumenda magnam in ipsum quod fuga officiis deserunt impedit eligendi, harum consectetur consequatur. Tempora, incidunt!</p>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tempora reprehenderit, quam est distinctio ipsam, ex assumenda magnam in ipsum quod fuga officiis deserunt impedit eligendi, harum consectetur consequatur. Tempora, incidunt!</p>
                            </div>
                            <h5 className="font-bold text-gray-300 text-2xl py-3">Title3</h5>
                            <div className="pl-5">
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tempora reprehenderit, quam est distinctio ipsam, ex assumenda magnam in ipsum quod fuga officiis deserunt impedit eligendi, harum consectetur consequatur. Tempora, incidunt!</p>
                                <ul className="list-disc pl-5">
                                    <li>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</li>
                        ...
                        <h1 className="font-bold text-4xl text-gray-300">Terms of use</h1>
                        <div className="p-5 font-thin">
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tempora reprehenderit, quam est distinctio ipsam, ex assumenda magnam in ipsum quod fuga officiis deserunt impedit eligendi, harum consectetur consequatur. Tempora, incidunt!</p>
                            <h5 className="font-bold text-gray-300 text-2xl py-3">Title1</h5>
                            <div className="pl-5">
                        ...
                        />
                        <Link to={"/"} className="flex justify-center bg-gradient-to-r from-sky-800 to-slate-800  hover:from-sky-800 hover:to-slate-600 p-4 text-white font-bold rounded-lg mx-10 my-5" >
                            Back to Home
                        </Link>
